...
import { Home, CreditCard, Building2, PiggyBank, Users, Send, Plane, HelpCircle, ArrowBigDown, Banknote, Landmark, Wallet, Headset, Copy, DollarSign, MessageSquare, BookOpen, Sparkles, List, ListPlus, HomeIcon, Share2, Zap } from "lucide-react"
...
export function DashboardSidebar() {
  ...
  const inviteLink = "https://splyt.online"
  const inviteText = "Split bills with friends using crypto. Zero fees. Zero friction. Check out Splyt! ⚡"
  const shareText = `${inviteText} ${inviteLink}`
  ...
  const handleShare = (platform: string) => {
    ...
    switch (platform) {
      ...
      case "whatsapp":
        ...
        break
      case "telegram":
        window.open(`https://t.me/share/url?url=${encodeURIComponent(url)}&text=${encodeURIComponent(inviteText)}`, "_blank")
        break
    }
  }
      ...
      <div className="flex-shrink-0 p-3 pb-3">
        <Card className="p-4 bg-card border border-border">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed mb-3">
            Invite friends to split bills instantly with zero fees. No awkward reminders, just fair splits.
          </p>
          ...
          <div className="grid grid-cols-4 gap-1.5">
            <button
              ...
              className="flex items-center justify-center p-2 rounded-lg bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#25D366] transition-colors"
            ...
            <button
              ...
              className="flex items-center justify-center p-2 rounded-lg bg-muted hover:bg-muted/80 text-foreground transition-colors"
              title="Share on X"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button
              ...
              className="flex items-center justify-center p-2 rounded-lg bg-[#0088cc]/10 hover:bg-[#0088cc]/20 text-[#0088cc] transition-colors"
